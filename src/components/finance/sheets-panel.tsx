 ...
 *
 * Правка книги отсюда не делается — у сервисного аккаунта только чтение, и это
 * обещание раздела «Таблицы», которое нельзя тихо отозвать. Поэтому ссылка на
 * саму книгу стоит рядом: работа в Google продолжается там, а её цифры живут
 * здесь.
 */
